...
ownerRouter.post("/update-profile", protect, verifyOwner, updateProfile);
ownerRouter.post("/change-password", protect, verifyOwner, changePassword);
ownerRouter.post("/delete-image", protect, verifyOwner, deleteProfileImage);
ownerRouter.post("/delete-account", protect, verifyOwner, deleteAccount);
